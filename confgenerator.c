...
int32_t confgenerator_serialize_mcconf(uint8_t *buffer, const mc_configuration *conf) {
	...
	buffer[ind++] = conf->foc_mtpa_power_cap;
...
int32_t confgenerator_serialize_appconf(uint8_t *buffer, const app_configuration *conf) {
	...
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_throttle_release_eps, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_throttle_duty_gate_span, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_throttle_duty_gate_min_scale, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_throttle_launch_boost_rel, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_throttle_launch_boost_throttle, &ind);
	...
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_hybrid_ramp_rise_time, &ind);
	...
	buffer[ind++] = conf->app_adc_conf.haz_pas_duty_enabled;
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_lead_pct, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_ramp_up, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_ramp_down, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_idle_timeout, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_cadence_smoothing, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_median_filter, &ind);
	buffer[ind++] = conf->app_adc_conf.haz_pas_duty_torque_enabled;
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_torque_min_offset, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_torque_max_offset, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_torque_flat_zone, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_torque_max_input, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_torque_smoothing, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_torque_idle_timeout, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_torque_cadence_avg, &ind);
	buffer[ind++] = conf->app_adc_conf.haz_torque_enable_current_pas;
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_strength, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_smoothing, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_start_threshold, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_idle_timeout, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_responsiveness, &ind);
	buffer[ind++] = conf->app_adc_conf.haz_torque_direct_enable;
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_max_current, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_in_low, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_out_low, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_in_mid, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_out_mid, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_in_high, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_out_high, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_cadence_start, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_cadence_full, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_cadence_min, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_speed_fade, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_ramp_up, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_torque_direct_ramp_down, &ind);
	buffer[ind++] = conf->app_adc_conf.haz_torque_direct_use_gears;
	buffer[ind++] = conf->app_adc_conf.haz_shift_assist_enabled;
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_shift_min_throttle, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_shift_slip_pct, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_shift_fallback_drop_pct, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_shift_drop_rate, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_shift_unload_offset, &ind);
	buffer_append_uint16(buffer, conf->app_adc_conf.haz_shift_hold_ms, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_shift_reload_current_a, &ind);
	buffer_append_uint16(buffer, conf->app_adc_conf.haz_shift_wait_timeout_ms, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_shift_restore_rate, &ind);
	buffer_append_uint16(buffer, conf->app_adc_conf.haz_shift_lockout_ms, &ind);
	buffer_append_uint16(buffer, conf->app_adc_conf.haz_shift_debounce_ms, &ind);
	...
	buffer[ind++] = (uint8_t)conf->app_nrf_conf.address_0;
	buffer[ind++] = (uint8_t)conf->app_nrf_conf.address_1;
	buffer[ind++] = (uint8_t)conf->app_nrf_conf.address_2;
	...
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_start_rotations, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_idle_timeout_s, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_target_lead, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_erpm_ramp_rate, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_cadence_filter, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_ramp_down_mult, &ind);
	...
	buffer_append_float32_auto(buffer, conf->imu_conf.accel_offsets_0, &ind);
	buffer_append_float32_auto(buffer, conf->imu_conf.accel_offsets_1, &ind);
	buffer_append_float32_auto(buffer, conf->imu_conf.accel_offsets_2, &ind);
	buffer_append_float32_auto(buffer, conf->imu_conf.gyro_offsets_0, &ind);
	buffer_append_float32_auto(buffer, conf->imu_conf.gyro_offsets_1, &ind);
	buffer_append_float32_auto(buffer, conf->imu_conf.gyro_offsets_2, &ind);
	buffer[ind++] = conf->gear_detect_conf.enabled;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.num_gears;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.chainring_teeth;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.motor_poles;
	...
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_1;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_2;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_3;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_4;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_5;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_6;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_7;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_8;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_9;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_10;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_11;
	buffer[ind++] = (uint8_t)conf->gear_detect_conf.cassette_teeth_12;
	...
	buffer_append_uint32(buffer, conf->gear_detect_conf.min_erpm, &ind);
...
bool confgenerator_deserialize_mcconf(const uint8_t *buffer, mc_configuration *conf) {
	...
	conf->foc_mtpa_power_cap = buffer[ind++];
...
bool confgenerator_deserialize_appconf(const uint8_t *buffer, app_configuration *conf) {
	...
	conf->app_adc_conf.haz_throttle_release_eps = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_throttle_duty_gate_span = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_throttle_duty_gate_min_scale = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_throttle_launch_boost_rel = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_throttle_launch_boost_throttle = buffer_get_float32_auto(buffer, &ind);
	...
	conf->app_adc_conf.haz_hybrid_ramp_rise_time = buffer_get_float32_auto(buffer, &ind);
	...
	conf->app_adc_conf.haz_pas_duty_enabled = buffer[ind++];
	conf->app_adc_conf.haz_pas_duty_lead_pct = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_ramp_up = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_ramp_down = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_idle_timeout = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_cadence_smoothing = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_median_filter = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_torque_enabled = buffer[ind++];
	conf->app_adc_conf.haz_pas_duty_torque_min_offset = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_torque_max_offset = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_torque_flat_zone = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_torque_max_input = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_torque_smoothing = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_torque_idle_timeout = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_torque_cadence_avg = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_enable_current_pas = buffer[ind++];
	conf->app_adc_conf.haz_torque_strength = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_smoothing = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_start_threshold = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_idle_timeout = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_responsiveness = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_enable = buffer[ind++];
	conf->app_adc_conf.haz_torque_direct_max_current = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_in_low = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_out_low = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_in_mid = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_out_mid = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_in_high = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_out_high = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_cadence_start = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_cadence_full = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_cadence_min = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_speed_fade = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_ramp_up = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_ramp_down = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_torque_direct_use_gears = buffer[ind++];
	conf->app_adc_conf.haz_shift_assist_enabled = buffer[ind++];
	conf->app_adc_conf.haz_shift_min_throttle = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_shift_slip_pct = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_shift_fallback_drop_pct = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_shift_drop_rate = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_shift_unload_offset = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_shift_hold_ms = buffer_get_uint16(buffer, &ind);
	conf->app_adc_conf.haz_shift_reload_current_a = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_shift_wait_timeout_ms = buffer_get_uint16(buffer, &ind);
	conf->app_adc_conf.haz_shift_restore_rate = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_shift_lockout_ms = buffer_get_uint16(buffer, &ind);
	conf->app_adc_conf.haz_shift_debounce_ms = buffer_get_uint16(buffer, &ind);
	...
	conf->app_nrf_conf.retries = buffer[ind++];
	conf->app_nrf_conf.channel = buffer[ind++];
	conf->app_nrf_conf.address_0 = buffer[ind++];
	conf->app_nrf_conf.address_1 = buffer[ind++];
	conf->app_nrf_conf.address_2 = buffer[ind++];
	...
	conf->app_pas_conf.pas_follow_start_rotations = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_idle_timeout_s = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_target_lead = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_erpm_ramp_rate = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_cadence_filter = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_ramp_down_mult = buffer_get_float32_auto(buffer, &ind);
	...
	conf->imu_conf.accel_offsets_0 = buffer_get_float32_auto(buffer, &ind);
	conf->imu_conf.accel_offsets_1 = buffer_get_float32_auto(buffer, &ind);
	conf->imu_conf.accel_offsets_2 = buffer_get_float32_auto(buffer, &ind);
	conf->imu_conf.gyro_offsets_0 = buffer_get_float32_auto(buffer, &ind);
	conf->imu_conf.gyro_offsets_1 = buffer_get_float32_auto(buffer, &ind);
	conf->imu_conf.gyro_offsets_2 = buffer_get_float32_auto(buffer, &ind);
	...
	conf->gear_detect_conf.cassette_teeth_1 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_2 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_3 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_4 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_5 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_6 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_7 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_8 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_9 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_10 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_11 = buffer[ind++];
	conf->gear_detect_conf.cassette_teeth_12 = buffer[ind++];
	...
	conf->gear_detect_conf.min_erpm = buffer_get_uint32(buffer, &ind);
...
void confgenerator_set_defaults_mcconf(mc_configuration *conf) {
	...
	conf->foc_mtpa_power_cap = MCCONF_FOC_MTPA_POWER_CAP;
...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->app_adc_conf.haz_throttle_release_eps = APPCONF_ADC_HAZ_THROTTLE_RELEASE_EPS;
	conf->app_adc_conf.haz_throttle_duty_gate_span = APPCONF_ADC_HAZ_THROTTLE_DUTY_GATE_SPAN;
	conf->app_adc_conf.haz_throttle_duty_gate_min_scale = APPCONF_ADC_HAZ_THROTTLE_DUTY_GATE_MIN_SCALE;
	conf->app_adc_conf.haz_throttle_launch_boost_rel = APPCONF_ADC_HAZ_THROTTLE_LAUNCH_BOOST_REL;
	conf->app_adc_conf.haz_throttle_launch_boost_throttle = APPCONF_ADC_HAZ_THROTTLE_LAUNCH_BOOST_THROTTLE;
	...
	conf->app_adc_conf.haz_hybrid_ramp_rise_time = APPCONF_ADC_HAZ_HYBRID_RAMP_RISE_TIME;
	...
	conf->app_adc_conf.haz_pas_duty_enabled = APPCONF_ADC_HAZ_PAS_DUTY_ENABLED;
	conf->app_adc_conf.haz_pas_duty_lead_pct = APPCONF_ADC_HAZ_PAS_DUTY_LEAD_PCT;
	conf->app_adc_conf.haz_pas_duty_ramp_up = APPCONF_ADC_HAZ_PAS_DUTY_RAMP_UP;
	conf->app_adc_conf.haz_pas_duty_ramp_down = APPCONF_ADC_HAZ_PAS_DUTY_RAMP_DOWN;
	conf->app_adc_conf.haz_pas_duty_idle_timeout = APPCONF_ADC_HAZ_PAS_DUTY_IDLE_TIMEOUT;
	conf->app_adc_conf.haz_pas_duty_cadence_smoothing = APPCONF_ADC_HAZ_PAS_DUTY_CADENCE_SMOOTHING;
	conf->app_adc_conf.haz_pas_duty_median_filter = APPCONF_ADC_HAZ_PAS_DUTY_MEDIAN_FILTER;
	conf->app_adc_conf.haz_pas_duty_torque_enabled = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_ENABLED;
	conf->app_adc_conf.haz_pas_duty_torque_min_offset = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_MIN_OFFSET;
	conf->app_adc_conf.haz_pas_duty_torque_max_offset = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_MAX_OFFSET;
	conf->app_adc_conf.haz_pas_duty_torque_flat_zone = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_FLAT_ZONE;
	conf->app_adc_conf.haz_pas_duty_torque_max_input = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_MAX_INPUT;
	conf->app_adc_conf.haz_pas_duty_torque_smoothing = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_SMOOTHING;
	conf->app_adc_conf.haz_pas_duty_torque_idle_timeout = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_IDLE_TIMEOUT;
	conf->app_adc_conf.haz_pas_duty_torque_cadence_avg = APPCONF_ADC_HAZ_PAS_DUTY_TORQUE_CADENCE_AVG;
	conf->app_adc_conf.haz_torque_enable_current_pas = APPCONF_ADC_HAZ_TORQUE_ENABLE_CURRENT_PAS;
	conf->app_adc_conf.haz_torque_strength = APPCONF_ADC_HAZ_TORQUE_STRENGTH;
	conf->app_adc_conf.haz_torque_smoothing = APPCONF_ADC_HAZ_TORQUE_SMOOTHING;
	conf->app_adc_conf.haz_torque_start_threshold = APPCONF_ADC_HAZ_TORQUE_START_THRESHOLD;
	conf->app_adc_conf.haz_torque_idle_timeout = APPCONF_ADC_HAZ_TORQUE_IDLE_TIMEOUT;
	conf->app_adc_conf.haz_torque_responsiveness = APPCONF_ADC_HAZ_TORQUE_RESPONSIVENESS;
	conf->app_adc_conf.haz_torque_direct_enable = APPCONF_ADC_HAZ_TORQUE_DIRECT_ENABLE;
	conf->app_adc_conf.haz_torque_direct_max_current = APPCONF_ADC_HAZ_TORQUE_DIRECT_MAX_CURRENT;
	conf->app_adc_conf.haz_torque_direct_in_low = APPCONF_ADC_HAZ_TORQUE_DIRECT_IN_LOW;
	conf->app_adc_conf.haz_torque_direct_out_low = APPCONF_ADC_HAZ_TORQUE_DIRECT_OUT_LOW;
	conf->app_adc_conf.haz_torque_direct_in_mid = APPCONF_ADC_HAZ_TORQUE_DIRECT_IN_MID;
	conf->app_adc_conf.haz_torque_direct_out_mid = APPCONF_ADC_HAZ_TORQUE_DIRECT_OUT_MID;
	conf->app_adc_conf.haz_torque_direct_in_high = APPCONF_ADC_HAZ_TORQUE_DIRECT_IN_HIGH;
	conf->app_adc_conf.haz_torque_direct_out_high = APPCONF_ADC_HAZ_TORQUE_DIRECT_OUT_HIGH;
	conf->app_adc_conf.haz_torque_direct_cadence_start = APPCONF_ADC_HAZ_TORQUE_DIRECT_CADENCE_START;
	conf->app_adc_conf.haz_torque_direct_cadence_full = APPCONF_ADC_HAZ_TORQUE_DIRECT_CADENCE_FULL;
	conf->app_adc_conf.haz_torque_direct_cadence_min = APPCONF_ADC_HAZ_TORQUE_DIRECT_CADENCE_MIN;
	conf->app_adc_conf.haz_torque_direct_speed_fade = APPCONF_ADC_HAZ_TORQUE_DIRECT_SPEED_FADE;
	conf->app_adc_conf.haz_torque_direct_ramp_up = APPCONF_ADC_HAZ_TORQUE_DIRECT_RAMP_UP;
	conf->app_adc_conf.haz_torque_direct_ramp_down = APPCONF_ADC_HAZ_TORQUE_DIRECT_RAMP_DOWN;
	conf->app_adc_conf.haz_torque_direct_use_gears = APPCONF_ADC_HAZ_TORQUE_DIRECT_USE_GEARS;
	conf->app_adc_conf.haz_shift_assist_enabled = APPCONF_ADC_HAZ_SHIFT_ASSIST_ENABLED;
	conf->app_adc_conf.haz_shift_min_throttle = APPCONF_ADC_HAZ_SHIFT_MIN_THROTTLE;
	conf->app_adc_conf.haz_shift_slip_pct = APPCONF_ADC_HAZ_SHIFT_SLIP_PCT;
	conf->app_adc_conf.haz_shift_fallback_drop_pct = APPCONF_ADC_HAZ_SHIFT_FALLBACK_DROP_PCT;
	conf->app_adc_conf.haz_shift_drop_rate = APPCONF_ADC_HAZ_SHIFT_DROP_RATE;
	conf->app_adc_conf.haz_shift_unload_offset = APPCONF_ADC_HAZ_SHIFT_UNLOAD_OFFSET;
	conf->app_adc_conf.haz_shift_hold_ms = APPCONF_ADC_HAZ_SHIFT_HOLD_MS;
	conf->app_adc_conf.haz_shift_reload_current_a = APPCONF_ADC_HAZ_SHIFT_RELOAD_CURRENT_A;
	conf->app_adc_conf.haz_shift_wait_timeout_ms = APPCONF_ADC_HAZ_SHIFT_WAIT_TIMEOUT_MS;
	conf->app_adc_conf.haz_shift_restore_rate = APPCONF_ADC_HAZ_SHIFT_RESTORE_RATE;
	conf->app_adc_conf.haz_shift_lockout_ms = APPCONF_ADC_HAZ_SHIFT_LOCKOUT_MS;
	conf->app_adc_conf.haz_shift_debounce_ms = APPCONF_ADC_HAZ_SHIFT_DEBOUNCE_MS;
	...
	conf->app_nrf_conf.address_0 = APPCONF_NRF_ADDR_B0;
	conf->app_nrf_conf.address_1 = APPCONF_NRF_ADDR_B1;
	conf->app_nrf_conf.address_2 = APPCONF_NRF_ADDR_B2;
	...
	conf->app_pas_conf.pas_follow_start_rotations = APPCONF_PAS_FOLLOW_START_ROTATIONS;
	conf->app_pas_conf.pas_follow_idle_timeout_s = APPCONF_PAS_FOLLOW_IDLE_TIMEOUT_S;
	conf->app_pas_conf.pas_follow_target_lead = APPCONF_PAS_FOLLOW_TARGET_LEAD;
	conf->app_pas_conf.pas_follow_erpm_ramp_rate = APPCONF_PAS_FOLLOW_ERPM_RAMP_RATE;
	conf->app_pas_conf.pas_follow_cadence_filter = APPCONF_PAS_FOLLOW_CADENCE_FILTER;
	conf->app_pas_conf.pas_follow_ramp_down_mult = APPCONF_PAS_FOLLOW_RAMP_DOWN_MULT;
	...
	conf->imu_conf.accel_offsets_0 = APPCONF_IMU_A_OFFSET_0;
	conf->imu_conf.accel_offsets_1 = APPCONF_IMU_A_OFFSET_1;
	conf->imu_conf.accel_offsets_2 = APPCONF_IMU_A_OFFSET_2;
	conf->imu_conf.gyro_offsets_0 = APPCONF_IMU_G_OFFSET_0;
	conf->imu_conf.gyro_offsets_1 = APPCONF_IMU_G_OFFSET_1;
	conf->imu_conf.gyro_offsets_2 = APPCONF_IMU_G_OFFSET_2;
	...
	conf->gear_detect_conf.cassette_teeth_1 = APPCONF_GEAR_DETECT_COG_1;
	conf->gear_detect_conf.cassette_teeth_2 = APPCONF_GEAR_DETECT_COG_2;
	conf->gear_detect_conf.cassette_teeth_3 = APPCONF_GEAR_DETECT_COG_3;
	conf->gear_detect_conf.cassette_teeth_4 = APPCONF_GEAR_DETECT_COG_4;
	conf->gear_detect_conf.cassette_teeth_5 = APPCONF_GEAR_DETECT_COG_5;
	conf->gear_detect_conf.cassette_teeth_6 = APPCONF_GEAR_DETECT_COG_6;
	conf->gear_detect_conf.cassette_teeth_7 = APPCONF_GEAR_DETECT_COG_7;
	conf->gear_detect_conf.cassette_teeth_8 = APPCONF_GEAR_DETECT_COG_8;
	conf->gear_detect_conf.cassette_teeth_9 = APPCONF_GEAR_DETECT_COG_9;
	conf->gear_detect_conf.cassette_teeth_10 = APPCONF_GEAR_DETECT_COG_10;
	conf->gear_detect_conf.cassette_teeth_11 = APPCONF_GEAR_DETECT_COG_11;
	conf->gear_detect_conf.cassette_teeth_12 = APPCONF_GEAR_DETECT_COG_12;
