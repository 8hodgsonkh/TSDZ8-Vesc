...
int32_t confgenerator_serialize_mcconf(uint8_t *buffer, const mc_configuration *conf) {
	...
	buffer[ind++] = (uint8_t)conf->tsdz8_ramp_up_inv_step;
	buffer[ind++] = (uint8_t)conf->tsdz8_ramp_down_inv_step;
	buffer[ind++] = (uint8_t)conf->tsdz8_gap_threshold_fast;
	buffer[ind++] = (uint8_t)conf->tsdz8_gap_threshold_med;
	buffer[ind++] = (uint8_t)conf->tsdz8_step_up_fast;
	buffer[ind++] = (uint8_t)conf->tsdz8_step_up_med;
	buffer[ind++] = (uint8_t)conf->tsdz8_step_up_slow;
	buffer[ind++] = (uint8_t)conf->tsdz8_step_down_fast;
	buffer[ind++] = (uint8_t)conf->tsdz8_step_down_slow;
	buffer[ind++] = (uint8_t)conf->tsdz8_startup_duty;
	buffer[ind++] = (uint8_t)conf->tsdz8_max_duty;
	buffer[ind++] = (uint8_t)conf->tsdz8_hall_ref_angle;
...
int32_t confgenerator_serialize_appconf(uint8_t *buffer, const app_configuration *conf) {
	...
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_variation_threshold, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_erpm_boost, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_effort_gain, &ind);
	...
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_ramp_rise_time, &ind);
	...
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_base_current_frac, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_base_rpm_full, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_kp_a_per_erpm, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_deadband_erpm, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_target_lead, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_ramp_up_base_a_per_s, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_ramp_up_full_a_per_s, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_ramp_up_rise_time_s, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_ramp_down_a_per_s, &ind);
...
bool confgenerator_deserialize_appconf(const uint8_t *buffer, app_configuration *conf) {
	...
	conf->app_adc_conf.haz_pas_duty_variation_threshold = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_erpm_boost = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_effort_gain = buffer_get_float32_auto(buffer, &ind);
	...
	conf->app_adc_conf.haz_pas_duty_ramp_rise_time = buffer_get_float32_auto(buffer, &ind);
	...
	conf->app_pas_conf.pas_follow_base_current_frac = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_base_rpm_full = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_kp_a_per_erpm = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_deadband_erpm = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_target_lead = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_ramp_up_base_a_per_s = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_ramp_up_full_a_per_s = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_ramp_up_rise_time_s = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_ramp_down_a_per_s = buffer_get_float32_auto(buffer, &ind);
...
void confgenerator_set_defaults_mcconf(mc_configuration *conf) {
	...
	conf->tsdz8_ramp_up_inv_step = 5;
	conf->tsdz8_ramp_down_inv_step = 50;
	conf->tsdz8_gap_threshold_fast = 50;
	conf->tsdz8_gap_threshold_med = 25;
	conf->tsdz8_step_up_fast = 4;
	conf->tsdz8_step_up_med = 2;
	conf->tsdz8_step_up_slow = 1;
	conf->tsdz8_step_down_fast = 8;
	conf->tsdz8_step_down_slow = 4;
	conf->tsdz8_startup_duty = 20;
	conf->tsdz8_max_duty = 230;
	conf->tsdz8_hall_ref_angle = 208;
	conf->tsdz8_pwm_mode = 0;
...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->app_adc_conf.haz_pas_duty_variation_threshold = APPCONF_ADC_HAZ_PAS_DUTY_VARIATION_THRESHOLD;
	conf->app_adc_conf.haz_pas_duty_erpm_boost = APPCONF_ADC_HAZ_PAS_DUTY_ERPM_BOOST;
	conf->app_adc_conf.haz_pas_duty_effort_gain = APPCONF_ADC_HAZ_PAS_DUTY_EFFORT_GAIN;
	...
	conf->app_adc_conf.haz_pas_duty_ramp_rise_time = APPCONF_ADC_HAZ_PAS_DUTY_RAMP_RISE_TIME;
	...
	conf->app_pas_conf.pas_follow_base_current_frac = APPCONF_PAS_FOLLOW_BASE_CURRENT_FRAC;
	conf->app_pas_conf.pas_follow_base_rpm_full = APPCONF_PAS_FOLLOW_BASE_RPM_FULL;
	conf->app_pas_conf.pas_follow_kp_a_per_erpm = APPCONF_PAS_FOLLOW_KP_A_PER_ERPM;
	conf->app_pas_conf.pas_follow_deadband_erpm = APPCONF_PAS_FOLLOW_DEADBAND_ERPM;
	conf->app_pas_conf.pas_follow_target_lead = APPCONF_PAS_FOLLOW_TARGET_LEAD;
	conf->app_pas_conf.pas_follow_ramp_up_base_a_per_s = APPCONF_PAS_FOLLOW_RAMP_UP_BASE_A_PER_S;
	conf->app_pas_conf.pas_follow_ramp_up_full_a_per_s = APPCONF_PAS_FOLLOW_RAMP_UP_FULL_A_PER_S;
	conf->app_pas_conf.pas_follow_ramp_up_rise_time_s = APPCONF_PAS_FOLLOW_RAMP_UP_RISE_TIME_S;
	conf->app_pas_conf.pas_follow_ramp_down_a_per_s = APPCONF_PAS_FOLLOW_RAMP_DOWN_A_PER_S;
