...
int32_t confgenerator_serialize_appconf(uint8_t *buffer, const app_configuration *conf) {
	...
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_smoothing, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_lead_pct, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_accel_gain, &ind);
	buffer_append_float32_auto(buffer, conf->app_adc_conf.haz_pas_duty_load_gain, &ind);
	...
	buffer[ind++] = conf->app_adc_conf.haz_torque_enabled;
...
bool confgenerator_deserialize_appconf(const uint8_t *buffer, app_configuration *conf) {
	...
	conf->app_adc_conf.haz_pas_duty_smoothing = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_lead_pct = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_accel_gain = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.haz_pas_duty_load_gain = buffer_get_float32_auto(buffer, &ind);
	...
	conf->app_adc_conf.haz_torque_enabled = buffer[ind++];
...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->app_adc_conf.haz_pas_duty_smoothing = APPCONF_ADC_HAZ_PAS_DUTY_SMOOTHING;
	conf->app_adc_conf.haz_pas_duty_lead_pct = APPCONF_ADC_HAZ_PAS_DUTY_LEAD_PCT;
	conf->app_adc_conf.haz_pas_duty_accel_gain = APPCONF_ADC_HAZ_PAS_DUTY_ACCEL_GAIN;
	conf->app_adc_conf.haz_pas_duty_load_gain = APPCONF_ADC_HAZ_PAS_DUTY_LOAD_GAIN;
	...
	conf->app_adc_conf.haz_torque_enabled = APPCONF_ADC_HAZ_TORQUE_ENABLED;
