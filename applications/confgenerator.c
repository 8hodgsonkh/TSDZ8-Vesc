...
int32_t confgenerator_serialize_appconf(uint8_t *buffer, const app_configuration *conf) {
	...
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_speed_limit_kmh, &ind);
	buffer_append_float32_auto(buffer, conf->app_pas_conf.pas_follow_speed_limit_decay, &ind);
...
bool confgenerator_deserialize_appconf(const uint8_t *buffer, app_configuration *conf) {
	...
	conf->app_pas_conf.pas_follow_speed_limit_kmh = buffer_get_float32_auto(buffer, &ind);
	conf->app_pas_conf.pas_follow_speed_limit_decay = buffer_get_float32_auto(buffer, &ind);
...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->app_pas_conf.pas_follow_speed_limit_kmh = APPCONF_PAS_FOLLOW_SPEED_LIMIT_KMH;
	conf->app_pas_conf.pas_follow_speed_limit_decay = APPCONF_PAS_FOLLOW_SPEED_LIMIT_DECAY;
