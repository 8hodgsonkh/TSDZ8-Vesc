...
// ============================================================================
// Wheel Speed Sensor - ADC-based threshold detection
// Uses motor temp pin with existing 10K resistor network
// Hall sensor: low when magnet present, 10K pulls high when no magnet
// ============================================================================
